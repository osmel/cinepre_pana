...
*/
/*
$config['base_url']	='http://67.205.182.175/'; // 'http://45.55.85.45';
$config['base_url']	='http://ligadelajusticia.dev.com/'; 
$config['base_url']	='http://165.227.184.12/'; 
*/
$config['base_url']	='http://cinepremios.com/'; 
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
*/
$config['sess_cookie_name']		= 'calimax_session';
...
$config['sess_table_name']		= 'calimax_sessions'; //'ci_sessions';
...
| addresses from which CodeIgniter should trust the HTTP_X_FORWARDcalimax_FOR
