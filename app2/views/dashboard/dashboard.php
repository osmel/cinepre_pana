				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<img src="<?php echo base_url()?>img/home1.png" class="">
							<!-- <img src="<?php echo base_url()?>img/lateralizquierdo.png" class="img-responsive sinizquierdo">
							 -->
							 <div class="contenedorbotoneshome">
							 <?php if ($this->session->userdata('session_participante') == true) { ?>
										<div class="col-md-12 text-center">								
												<a href="<?php echo base_url(); ?>record/<?php echo $this->session->userdata('id_participante'); ?>" class="ingresarhome">MI MARCADOR</a>
											</div>
									
				             <?php }else{ ?>
									
											<div class="col-lg-12 col-md-6 text-center">								
												<a href="<?php echo base_url(); ?>ingresar_usuario" ><img src="<?php echo base_url(); ?>img/login.png"></a>
											</div>
											<div class="col-lg-12 col-md-6 text-center">
												<a href="<?php echo base_url()?>registro_usuario" ><img src="<?php echo base_url(); ?>img/registrarme1.png"></a>
											</div>
				             <?php } ?> 
				         	</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<img src="<?php echo base_url()?>img/home2.png" class="">
							<!-- <img src="<?php echo base_url()?>img/lateralizquierdo.png" class="img-responsive sinizquierdo">
							 -->
						</div>
						<div class="col-md-2">
						...
						<div class="ganar col-lg-5 col-md-5 col-sm-5 col-xs-12">
							<!-- <img src="<?php echo $this->session->userdata('c10'); ?>" class="img-responsive"> -->
							<!-- <img src="<?php echo base_url()?>img/lateralderecho.png" class="img-responsive sinizquierdo" style="margin-top: 45px;">
						 --></div>
